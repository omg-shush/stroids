...
impl VulkanSwapchain {
    pub fn new(surface_loader: &Surface, surface: &SurfaceKHR, card: &PhysicalDevice, instance: &Instance, device: &Device,
        ...
        let framebuffers = VulkanSwapchain::init_framebuffers(&device, &render_pass, &image_views, surface_caps.current_extent)?;
    ...
    fn init_framebuffers(device: &Device, render_pass: &RenderPass, swapchain_image_views: &Vec<ImageView>, extent: Extent2D)
